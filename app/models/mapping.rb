class Mapping < ApplicationRecord
	...
	validates :name, uniqueness: { scope: [:cloudbed_id, :qbo_id], message: " : This Mapping Combination Already Exists." }
	...
	def get_display_name(mapping_name, mapping_id, source)
		...
		elsif mapping_name == MAPPING_TYPES[1] || mapping_name == MAPPING_TYPES[2]
			if source == 'QuickBook'
